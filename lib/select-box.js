...
module.exports = React.createClass({
	...
	isSearchable: function () {
		return this.state.searchVisible && this.state.searchEnabled;
	},
		...
		return button(
			{
				...
				ref: 'button',
				className: 'react-select-box',
				onClick: () => this.toggleOpenClose() && this.toggleSearchInput(),
				onBlur: this.handleBlur,
				tabIndex: '0',
				'aria-hidden': true
			},
		...
		return input(
			{
				id: this.state.id,
				ref: 'searchInput',
				className: 'react-select-box-search',
				onChange: () => null, //items filter fn,
				onBlur: () => this.toggleOpenClose() && this.toggleSearchInput(),
				tabIndex: '0',
				'aria-hidden': true
			},
			div({className: 'react-select-box-label'}, this.label()))
